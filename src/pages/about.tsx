    ...
    return(
        <section id="about me">
          ...
          /></h1>
            ...
            <p style={{marginLeft: "6%", marginRight: "6%", padding: "30px", color: "rgb(165, 118, 0)"}}>Born and raised in Edmonton, Alberta, I moved across Canada to attend the University of Waterloo's renowned Computer Engineering program. 
            ...
            <p style={{marginLeft: "6%", marginRight: "6%", padding: "30px", color: "rgb(165, 118, 0)" }}>Since I was first introduced to the world of computers as a young child marvelling at the magic black boxes that were called cell phones, 
            ...
            <p style={{marginLeft: "6%", marginRight: "6%", padding: "30px", color: "rgb(165, 118, 0)" }}>As a lifelong athlete, sport has always played a significant role in my everyday life. Though training is as fun as a hobby to me, 
            ...
            <p style={{marginLeft: "6%", marginRight: "6%", padding: "30px", color: "rgb(165, 118, 0)" }}>Music was my first love. For as long as I can remember, I have been playing and performing music, whether it be the piano, cello, or trombone.
